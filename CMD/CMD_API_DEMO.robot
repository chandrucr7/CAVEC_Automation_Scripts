...
*** Variables ***
${base_url}=    https://apidemo.digitap.work
...
Test Case 01
    ...
    ${request_body}=   Evaluate    { "mobile": "9790590318", "requested_services": "whatsapp,paytm,amazon,flipkart,facebook,twitter,instagram,apple,linkedin", "client_ref_num": "Vampire", "is_cache_enabled": False }
    ...
    FOR    ${i}    IN RANGE    10
        ...
        Run Keyword If    '${result1}' == 'In-Progress'   Log To Console    Test case waiting for 20 secs
        Sleep    7s
...
Test Case 20
    ...
    ${auth}=  Create List    740513625625    DQqdokAmK7DJxOjX5hHUnEjS1Ea78zmg
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${request_body}=   Evaluate    { "mobile": "6790590318", "requested_services": "whatsapp,paytm,amazon,flipkart,facebook,twitter,instagram,apple,linkedin", "client_ref_num": "Vampire", "is_cache_enabled": False }
    ${headers}=  Create Dictionary    Content-Type=application/json
...
Test Case 21
    ...
    ${auth}=  Create List    740513625625    DQqdokAmK7DJxOjX5hHUnEjS1Ea78zmg
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${request_body}=   Evaluate    { "mobile": "919790590318", "requested_services": "whatsapp,paytm,amazon,flipkart,facebook,twitter,instagram,apple,linkedin", "client_ref_num": "Vampire", "is_cache_enabled": False }
    ${headers}=  Create Dictionary    Content-Type=application/json
    ${response}=  Post Request    myrequestsession   ${cmd_mobile_request_url}   json=${request_body}   headers=${headers}
...
Test Case 23
    ...
    ${auth}=  Create List    740513625625    DQqdokAmK7DJxOjX5hHUnEjS1Ea78zmg
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${request_body}=   Evaluate    { "mobile": "09790590318", "requested_services": "whatsapp,paytm,amazon,flipkart,facebook,twitter,instagram,apple,linkedin", "client_ref_num": "Vampire", "is_cache_enabled": False }
    ${headers}=  Create Dictionary    Content-Type=application/json
    ${response}=  Post Request    myrequestsession   ${cmd_mobile_request_url}   json=${request_body}   headers=${headers}
...
Test Case 24
    ...
    ${auth}=  Create List    740513625625    DQqdokAmK7DJxOjX5hHUnEjS1Ea78zmg
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${request_body}=   Evaluate    { "mobile": "+447850226627", "requested_services": "whatsapp,paytm,amazon,flipkart,facebook,twitter,instagram,apple,linkedin", "client_ref_num": "Vampire", "is_cache_enabled": False }
    ${headers}=  Create Dictionary    Content-Type=application/json
    ${response}=  Post Request    myrequestsession   ${cmd_mobile_request_url}   json=${request_body}   headers=${headers}
...
Test Case 33
    ...
    ${auth}=  Create List    740513625625    DQqdokAmK7DJxOjX5hHUnEjS1Ea78zmg
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${request_body}=   Evaluate    { "email": "chandraprakashcr7@gmail.com", "requested_services": "whatsapp,paytm,amazon,flipkart,facebook,twitter,instagram,apple,linkedin", "client_ref_num": "Vampire", "is_cache_enabled": False }
    ${headers}=  Create Dictionary    Content-Type=application/json
...
Test Case 43
    ...
    ${auth}=  Create List    740513625625    DQqdokAmK7DJxOjX5hHUnEjS1Ea78zmg
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${request_body}=   Evaluate    { "email": "9790590318@gmail.com", "requested_services": "whatsapp,paytm", "client_ref_num": "Vampire", "is_cache_enabled": False }
    ${headers}=  Create Dictionary    Content-Type=application/json
    ${response}=  Post Request    myrequestsession   ${cmd_email_request_url}   json=${request_body}   headers=${headers}
...
Test Case 56
    ...
    ${auth}=  Create List    740513625625    DQqdokAmK7DJxOjX5hHUnEjS1Ea78zmg
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${request_body}=   Evaluate    { "mobile": "9790590318", "requested_services": "whatsapp,paytm,amazon,flipkart,facebook,twitter,instagram,apple,linkedin", "client_ref_num": "chandraprakashDchandraprakashDchandraprakashD", "is_cache_enabled": False }
    ${headers}=  Create Dictionary    Content-Type=application/json
    ${response}=  Post Request    myrequestsession   ${cmd_mobile_request_url}   json=${request_body}   headers=${headers}
...
Test_case75
    ...
    ${auth}=    create list    740513625625    DQqdokAmK7DJxOjX5hHUnEjS1Ea78zmg
    create session    mysession    ${base_url}    auth=${auth}    verify=true
    ${body}=   Evaluate    { "email": "chandraprakashcr7@gmail.com", "requested_services": "amazon,paytm,facebook,instagram,twitter,whatsapp,linkedin", "client_ref_num": "Vampire", "is_cache_enabled": False }
    ${header}=    create dictionary    Content-Type=application/json
    ${response}=    Post Request     mysession     ${cmd_mobile_request_url}   json=${body}    headers=${header}
    Log To Console    ${body}
    Log To Console    ${response.status_code}
...
Test_case76
    ...
    ${auth}=    create list    740513625625    DQqdokAmK7DJxOjX5hHUnEjS1Ea78zmg
    create session    mysession    ${base_url}    auth=${auth}    verify=true
    ${body}=   Evaluate    { "mobile": "9790590318", "requested_services": "amazon,paytm,facebook,instagram,twitter,whatsapp,linkedin", "client_ref_num": "Vampire", "is_cache_enabled": False }
    ${header}=    create dictionary    Content-Type=application/json
    ${response}=    Post Request     mysession     ${cmd_email_request_url}   json=${body}    headers=${header}
    Log To Console    ${body}
    Log To Console    ${response.status_code}
...
Test Case 80
    ...
    ${auth}=  Create List    740513625625    DQqdokAmK7DJxOjX5hHUnEjS1Ea78zmg
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${body}=   Evaluate    { "mobile":"9790590318", "client_ref_num":"Vampire", "requested_services": "whatsapp,paytm,amazon,flipkart,facebook,twitter,instagram,apple,linkedin", "generate_score": True, "is_cache_enabled": False }
    ${headers}=  Create Dictionary    Content-Type=application/json
...
Test Case 81
    ...
    ${auth}=  Create List    740513625625    DQqdokAmK7DJxOjX5hHUnEjS1Ea78zmg
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${body}=   Evaluate    { "mobile":"9790590318", "client_ref_num":"Vampire", "requested_services": "whatsapp,paytm,amazon,flipkart,facebook,twitter,instagram,apple,linkedin", "generate_score": False, "is_cache_enabled": False }
    ${headers}=  Create Dictionary    Content-Type=application/json
    ${response}=  Post Request    myrequestsession   ${cmd_mobile_request_url}   json=${body}   headers=${headers}
...
Test Case 83
    Log To Console    CMD Request URL
    Log To Console    Verify by entering is cache enabled as true
    ${start_time}=    Get Current Date    result_format=%Y-%m-%d %H:%M:%S
    ${auth}=  Create List    740513625625    DQqdokAmK7DJxOjX5hHUnEjS1Ea78zmg
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${body}=   Evaluate    { "mobile":"9790590318", "client_ref_num":"Vampire", "requested_services": "whatsapp,paytm,amazon,flipkart,facebook,twitter,instagram,apple,linkedin", "is_cache_enabled": True }
    ${headers}=  Create Dictionary    Content-Type=application/json
    ${response}=  Post Request    myrequestsession   ${cmd_mobile_request_url}   json=${body}   headers=${headers}
...
Test Case 84
    Log To Console    CMD Request URL
    Log To Console    Verify by entering is cache enabled as False
    ${start_time}=    Get Current Date    result_format=%Y-%m-%d %H:%M:%S
    ${auth}=  Create List    740513625625    DQqdokAmK7DJxOjX5hHUnEjS1Ea78zmg
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${body}=   Evaluate    { "mobile":"9790590318", "client_ref_num":"Vampire", "requested_services": "whatsapp,paytm,amazon,flipkart,facebook,twitter,instagram,apple,linkedin", "is_cache_enabled": False }
    ${headers}=  Create Dictionary    Content-Type=application/json
    ${response}=  Post Request    myrequestsession   ${cmd_mobile_request_url}   json=${body}   headers=${headers}
...
Test Case 85
    Log To Console    CMD Request URL
    Log To Console    Verify by entering is cache enabled as true in string
    ${start_time}=    Get Current Date    result_format=%Y-%m-%d %H:%M:%S
    ${auth}=  Create List    740513625625    DQqdokAmK7DJxOjX5hHUnEjS1Ea78zmg
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${body}=   Evaluate    { "mobile":"9790590318", "client_ref_num":"Vampire", "requested_services": "whatsapp,paytm,amazon,flipkart,facebook,twitter,instagram,apple,linkedin", "is_cache_enabled": "true" }
...
Test_case86
    ...
    ${auth}=    Create List    77554771    uclFHVeMlS1o8qXdGGLKPztZahh5C6dn
    Create Session    mysession    ${base_url}    auth=${auth}    verify=true
    ${random_client_ref_num}=    Generate Random String    10    [LETTERS]

    #------------------------------------------ Request endpoint encryption-----------------------------------------------
    ${encrypt_body}=   Evaluate    { "plain_payload": { "mobile": "9790590318", "requested_services": "whatsapp,paytm,amazon,flipkart,facebook,twitter", "client_ref_num": "${random_client_ref_num}" }, "secret_name": "cavec_test_suit_secrets", "secret_key": "digitap_public", "kms_id": "46ab9f4e-1188-416b-83bd-f70126c018f5", "encryption_type": "jwe" }
    ${headers}=    Create Dictionary    Content-Type=application/json
    Log To Console    Encrypt Request Body: ${encrypt_body}

    ${encrypt_response}=    Post Request     mysession     https://svcint.digitap.work/validation/v1/encrypt   json=${encrypt_body}    headers=${headers}
    ...
    ${CAD_Request_Response}=    Post Request     mysession     /dp/mobile_check/v1/request   json=${pan_aadhaar_body}    headers=${headers}
    ...
    ${decrypt_body}=   Evaluate    { "encrypted_response": "${encrypted_data_output}", "secret_name": "cavec_test_suit_secrets", "secret_key": "77554771_private", "kms_id": "46ab9f4e-1188-416b-83bd-f70126c018f5", "encryption_type": "jwe" }
    Log To Console    Decrypt Request Body: ${decrypt_body}

    ${decrypt_response}=    Post Request     mysession     https://svcint.digitap.work/validation/v1/decrypt   json=${decrypt_body}    headers=${headers}
    ...
    ${encrypt_body}=   Evaluate    { "plain_payload": { "request_id": "${encrypted_data_output1}" }, "secret_name": "cavec_test_suit_secrets", "secret_key": "digitap_public", "kms_id": "46ab9f4e-1188-416b-83bd-f70126c018f5", "encryption_type": "jwe" }
    ${headers}=    Create Dictionary    Content-Type=application/json
    Log To Console    Encrypt Request Body: ${encrypt_body}
    ...
    ${CAD_Request_Response}=    Post Request     mysession     /dp/mobile_check/v1/status   json=${pan_aadhaar_body}    headers=${headers}
    Log To Console    CAD Link Response Status: ${CAD_Request_Response.status_code}
    Log To Console    CAD Response Content: ${CAD_Request_Response.content}
