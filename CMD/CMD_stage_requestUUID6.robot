...
Test Case 93
    ...
    ${auth}=  Create List    5265263150471    EA6F34B4B3B618A10CF5C22232290778
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${body}=   Evaluate    { "request_id":"1efe50ed-7b5c-6aaf-8314-c76e64a5c5b" }
    ${headers}=  Create Dictionary    Content-Type=application/json
    ${response}=  Post Request    myrequestsession   ${cmd_mobile_status_url}   json=${body}   headers=${headers}

    Log To Console    The request body input is : ${body}
    Log To Console    The response body output is :${response.content}

    Should Be Equal As Strings    ${response.json()['http_response_code']}  406
    Should Be Equal As Strings    ${response.json()['status']}  Error
    Should Be Equal As Strings    ${response.json()['error']}  Could not find Request Id
...
Test Case 94
    ...
    ${auth}=  Create List    5265263150471    EA6F34B4B3B618A10CF5C22232290778
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${body}=   Evaluate    { "request_id":"${EMPTY}" }
    ${headers}=  Create Dictionary    Content-Type=application/json
    ${response}=  Post Request    myrequestsession   ${cmd_mobile_status_url}   json=${body}   headers=${headers}
    ...
    Should Be Equal As Strings    ${response.json()['request_id']}  ${EMPTY}
    Should Be Equal As Strings    ${response.json()['error']}  One or more parameters format is wrong
...
Test Case 95
    ...
    ${auth}=  Create List    5265263150471    EA6F34B4B3B618A10CF5C22232290778
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${body}=   Evaluate    { "request_id":"${SPACE}" }
    ${headers}=  Create Dictionary    Content-Type=application/json
    ${response}=  Post Request    myrequestsession   ${cmd_mobile_status_url}   json=${body}   headers=${headers}
...
Test Case 96
    ...
    ${auth}=  Create List    5265263150471    EA6F34B4B3B618A10CF5C22232290778
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${body}=   Evaluate    { "request_id":"1efe50ed-7b5c-6aaf-8314-c76e64a5c5b1 " }
    ${headers}=  Create Dictionary    Content-Type=application/json
    ${response}=  Post Request    myrequestsession   ${cmd_mobile_status_url}   json=${body}   headers=${headers}
...
Test Case 99
    Log To Console    CMD Status URL
    Log To Console    Verify by entering empty space middle of request id
    ${start_time}=    Get Current Date    result_format=%Y-%m-%d %H:%M:%S
    ${auth}=  Create List    5265263150471    EA6F34B4B3B618A10CF5C22232290778
    Create Session    myrequestsession    ${base_url}   auth=${auth}   verify=True
    ${body}=   Evaluate    { "request_id":"1efe50ed-7b5c-6aaf-8314-c76e64a5c5b1" }
