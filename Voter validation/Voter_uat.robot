...
${file_path}=   C:\\Users\\kbinm18681\\PycharmProjects\\CAVEC\\Validation api\\Voter validation\\VoterData.csv
...
Test_case1
    ...
    ${auth}=    create list    740513625625    87709223222c5fc01a816b3b4b43f6ae
    ...
    ${response}=    Post Request    mysession     /v1/kyc_voter_verification_api    json=${body}    headers=${header}
    Log To Console    ${body}
