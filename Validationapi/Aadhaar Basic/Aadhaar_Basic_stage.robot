...
Test_case75
    ...
    ${header}=    create dictionary    Content-Type=application/json
    ${response}=    Get Request     mysession     /validation/kyc/v1/basic_aadhaar   json=${body}    headers=${header}
    Log To Console    ${body}
    Log To Console    ${response.status_code}
    Log To Console    ${response.content}
...
Test_case76
    ...
    ${header}=    Create Dictionary    Content-Type=application/json
    ${response}=    Options Request    mysession    /validation/kyc/v1/basic_aadhaar    headers=${header}
...
Test Case 78
    ...
    # Send POST request
    ${response}=    Post Request    mysession     /validation/kyc/v1/basic_aadhaar
    ...    json=${body}
    ...    headers=${header}
    ...
    Run Keyword And Continue On Failure    Should Be Equal As Strings    ${response_headers['Content-Length']}    157
...
Test_case80
    ...
    ${header}=    create dictionary    Content-Type=application/json
    ${response}=    Post Request     mysession     /validation/kyc/v1/basic_aadhaars   json=${body}    headers=${header}
    Log To Console    ${body}
    Log To Console    ${response.status_code}
    Log To Console    ${response.content}
