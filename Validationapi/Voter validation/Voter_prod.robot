...
${file_path}=   C:\\Users\\ChandraPrakash\\PycharmProjects\\KYCValidations\\Validationapi\\Voter validation\\VoterData.csv
...
Test_case1
    ...
    ${response}=    Post Request    mysession     /validation/kyc/v1/voter    json=${body}    headers=${header}
    Log To Console    ${body}
