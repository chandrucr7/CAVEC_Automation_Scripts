...
${file_path}=  C:\\Users\\DELL\\PycharmProjects\\KYCValidations\\Validationapi\\Pan Aadhaar link\\PanAadhaarLinkData.csv
#${json_schema_file}=    C:\\Users\\ChandraprakashD\\PycharmProjects\\KYCValidations\\Validationapi\\Pan to fName\\Pan_aadhaar_link_Json_schema.json.json
${json_schema_file}=  C:\\Users\\DELL\\PycharmProjects\\KYCValidations\\Validationapi\\Pan Aadhaar link\\Pan_aadhaar_link_Json_schema.json
